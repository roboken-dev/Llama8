...
import org.firstinspires.ftc.teamcode.LlamaBot;
...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.1558165899;
...
//        color = hardwareMap.get(ColorSensor.class, "color");
    ...
    public void openClawStep() throws InterruptedException {
        clawPosition += LlamaBot.CLAW_STEP;
        if (clawPosition > LlamaBot.CLAW_OPEN) {
            clawPosition = LlamaBot.CLAW_OPEN;
        }
        claw.setPosition(clawPosition);
        Thread.sleep(50);
    ...
    public void closeClawStep() throws InterruptedException {
        clawPosition -= LlamaBot.CLAW_STEP;
        if (clawPosition < LlamaBot.CLAW_CLOSE) {
            clawPosition = LlamaBot.CLAW_CLOSE;
        }
        claw.setPosition(clawPosition);
        Thread.sleep(50);
    ...
    public double[] findTargetPosition() {
        while (true) {
            double[] vals = new double[2];
            double D = 5.25;
            double LEFT_OFFSET = 4.5;
